...
set(SHADERC_ROOT "C:/Users/SpencerFricke/.cdep/exploded/com.github.ggfan/shaderc/0.0.1/shaderc-headers.zip/include")
function(add_cdep_shaderc_dependency target)
  ...
  set(cdep_exploded_root "C:/Users/SpencerFricke/.cdep/exploded")
  ...
  execute_process(COMMAND "C:/Program Files/Java/jdk1.8.0_25/jre/bin/java.exe" -classpath "C:/Users/SpencerFricke/.cdep/bootstrap/downloads/341618205/cdep-0.8.24.jar" io.cdep.CDep --working-folder "C:/Users/SpencerFricke/Documents/GitHub/VARTIP/." fetch-archive com.github.ggfan:shaderc:0.0.1 https://github.com/ggfan/shaderc/releases/download/0.0.1/shaderc-headers.zip 23993 5bfdf4f2226fb3128127c72a6c199a0abcde38b9c797e0ccbe6d6e511112ab0d)
  ...
  if(CMAKE_SYSTEM_NAME STREQUAL "Android")
    if(cdep_determined_android_runtime STREQUAL "gnustl_shared")
      if(cdep_determined_android_platform_level GREATER 23)
        ...
        elseif(cdep_determined_android_abi STREQUAL "x86_64")
          ...
          message(FATAL_ERROR "Android ABI ${cdep_determined_android_abi} is not supported by com.github.ggfan:shaderc:0.0.1 for platform ${cdep_determined_android_platform_level}. Supported: armeabi armeabi-v7a arm64-v8a x86 x86_64 ")
        endif()
      else()
        message(FATAL_ERROR "Android API level ${cdep_determined_android_platform_level} is not supported by com.github.ggfan:shaderc:0.0.1")
      endif()
    ...
    elseif(cdep_determined_android_runtime STREQUAL "none")
      ...
      message(FATAL_ERROR "Android runtime '${cdep_determined_android_runtime}' is not supported by com.github.ggfan:shaderc:0.0.1. Supported: gnustl c++ ")
    endif()
  else()
